...
for(subject_id in 1:30) {
  for(map_id in 1:30) {
    ...
    block_1_to_5 <- floor((order_1_to_30 - 1) / 6) + 1
...
experiment_table$block_1_to_5 <- as.factor(experiment_table$block_1_to_5)
experiment_table$subject_id <- as.factor(experiment_table$subject_id)

anomod <- aov(err_ratio ~ subject_id + map_id + block_1_to_5, data=experiment_table)
summary(anomod)

fit.lm <- lm(err_ratio ~ subject_id + map_id + block_1_to_5, data=experiment_table)
summary(fit.lm)
```
